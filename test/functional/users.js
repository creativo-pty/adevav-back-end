...
describe('User resources', () => {
  ...
  describe('POST /users', () => {
    ...
    describe('bad request', () => {
      ...
      it('should return a 400 Bad Request if the "Is Associate" flag is missing from the payload', (done) => {
        const invalidPayload = Object.assign({}, validPayload);
        delete invalidPayload.isAssociate;
        ...
        return callServer(invalidPayload, validTokens['Administrator'], ({ result, statusCode, statusMessage }) => {
          ...
          expect(result).to.equal({
            statusCode: 400,
            error: 'Bad Request',
            message: 'child "Is Associate" fails because ["Is Associate" is required]',
            validation: {
              source: 'payload',
              keys: ['isAssociate']
            }
      ...
      it('should return a 400 Bad Request if the "Is Public" flag is missing from the payload', (done) => {
        const invalidPayload = Object.assign({}, validPayload);
        delete invalidPayload.isPublic;
        ...
        return callServer(invalidPayload, validTokens['Administrator'], ({ result, statusCode, statusMessage }) => {
          ...
          expect(result).to.equal({
            statusCode: 400,
            error: 'Bad Request',
            message: 'child "Is Public" fails because ["Is Public" is required]',
            validation: {
              source: 'payload',
              keys: ['isPublic']
            }
